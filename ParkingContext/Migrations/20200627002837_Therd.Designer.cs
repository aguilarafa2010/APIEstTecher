...
namespace ParkingContext.Migrations
{
    ...
    [Migration("20200627002837_Therd")]
    partial class Therd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingModel.PatioEstacionamento", b =>
                {
                    ...
                    b.Property<string>("InformacoesJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ParkingModel.PatioEstacionamento+Informacoes", b =>
                {
                    b.Property<int>("DanosId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<Guid?>("PatioEstacionamentoEntrada")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("DanosId");

                    b.HasIndex("PatioEstacionamentoEntrada");
            ...
            modelBuilder.Entity("ParkingModel.PatioEstacionamento+Informacoes", b =>
                {
                    b.HasOne("ParkingModel.PatioEstacionamento", null)
                        .WithMany("Info")
                        .HasForeignKey("PatioEstacionamentoEntrada");
                });
